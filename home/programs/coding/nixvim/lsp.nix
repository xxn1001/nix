...
}:
{
  programs.nixvim.plugins = {
    ...
    conform-nvim = {
      enable = true;
      settings = {
        format_on_save = { lsp_fallback = "fallback"; timeout_ms = 500; };
    ...
    lspsaga = {
      enable = true;
      settings.lightbulb = { virtualText = true; sign = false; };
    };
    trouble.enable = true;
  ...
  programs.nixvim.keymaps = [
    ...
    { mode = "n"; key = "<Leader>lo"; action = ":Lspsaga outline<CR>"; }
    { mode = "n"; key = "<Leader>lr"; action = ":Lspsaga rename<CR>"; }
    { mode = "n"; key = "<Leader>la"; action = ":Lspsaga code_action<CR>"; }
    { mode = "n"; key = "<Leader>lf"; action = ":Lspsaga finder<CR>"; }
  ];
  programs.nixvim.extraPlugins = with pkgs.vimPlugins; [ nvim-docs-view ];
}
